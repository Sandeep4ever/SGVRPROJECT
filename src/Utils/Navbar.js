...
const Navbar = () => {
    return (
        <MainNavContainer>
           ...
           <SecondContainer>
           <NavLink to="/messages">
              {/* <div style={{display:'inline-block',height:"20px",width:'24px'}}><SvgIcon component="object">
  ...
  <g id="Ellipse_37" data-name="Ellipse 37" transform="translate(10.027 1)" fill="#d3161c" stroke="#fff" stroke-width="1">
    <circle cx="5" cy="5" r="5" stroke="none"/>
    <circle cx="5" cy="5" r="4.5" fill="none"/>
  </g>
       </SvgIcon>
